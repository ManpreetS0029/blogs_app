    ...
    <>
      <div className="bg-white">
        <div class="mx-auto max-w-7xl px-4">
          ...
          <div class="mx-auto max-w-7xl py-1 md:py-16">
              ...
              <div class="flex items-center justify-center">
                <div class="px-2 md:px-12">
                  ...
                  <form action="" class="mt-8 space-y-4">
                    ...
                    <button
                      type="button"
                      class="w-full rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:border-white dark:focus-visible:outline-white"
                    >
                      Send Message
                    </button>
                  </form>
